...
<body>
    <form id="form1" runat="server">
        ...
        <asp:ListBox ID="lstOrderList" runat="server" Height="348px" Width="435px"></asp:ListBox>
        <p>
        ...
        <p>
            Enter your Order Name<asp:TextBox ID="txtOrderName" runat="server"></asp:TextBox>
        </p>
        <p>
